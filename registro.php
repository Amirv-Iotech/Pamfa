 ...
 <tr>
           ...
           <tr>
              <td> <label> Nombre del representante legal:</label></td>
               ...
               <td> <label>Direccion:</label><input class="form-control" type="text" name="direccion" value=""  size="32" /></td>
                 <td><label>Colonia:</label><input class="form-control"  type="text" name="colonia" value=""  size="32" /></td></tr>
           <tr>
               <td> <label>Municipio:</label><input class="form-control"  type="text" name="municipio" value=""  size="32" /></td>
           
                <td> <label>Estado:</label> <input class="form-control"  type="text" name="estado" value=""  size="32" /></td></tr>
          <tr>
              <td> <label>Pais:</label> <input class="form-control" type="text" name="pais" value=""  size="32" /></td>       
                <td> <label>C.P:</label> <input class="form-control"  type="text" name="cp" value=""  size="32" /></td></tr>
           
                <td> <label>Coordenadas:</label><input class="form-control"  type="text" name="coordenadas" value=""  size="32" /></td>
          
                 <td><label>Email:</label><input class="form-control"  type="text" name="email" value=""  size="32" /></td></tr>
           <tr>
                <td> <label>Teléfono:</label> <input class="form-control"  type="text" name="telefono" value=""  size="32" /></td>
           ...
           <tr>
                ...
                <td> <label>4 ultimos digitos de tarjeta:</label><input class="form-control"  type="text" name="digitos_tarjeta" value=""  size="32" /></td></tr>
           <tr><td colspan="1">
