    ...
    <form method="post" action="#seccion8">
      <div class="col-lg-12 col-xs-12 campos2">
          ...
          ?>  <div class="col-lg-4 col-xs-4 campos2" style=" padding: 0px 0px; border:solid 1px #AAAAAA;">
              <label><input id="idsrrc" <? if ($row_solicitud['idsrrc']==$row_srrc['idsrrc']){?> checked="checked"<? }?>  type="checkbox" value="<? echo $row_srrc['idsrrc'];?>" name="idsrrc"><? echo $row_srrc['seccion'];?></label></div>
            <?}
            else {?>
          ...
          <div class="col-lg-12 col-xs-12 campos2">
              <div class="col-lg-6 col-xs-6 campos2" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height: 87px;">
                 ...
                 <input  class="form-control" id="srrc_preg1" placeholder=" " name="srrc_preg1" type="text"      title="Número " value="<? echo $row_solicitud['srrc_preg1'];?>" />
                </div>
              </div>
                  <div class="col-lg-6 col-xs-6 campos2" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height: 87px;">
                     <span>Número de productores del área integral:</span>
                     <div class="form-group campos2 div4">
                        <input  class="form-control " id="srrc_preg2" placeholder=" " name="srrc_preg2" type="text"      title="Número " value="<? echo $row_solicitud['srrc_preg2'];?>" />
                      </div>
                  </div>
              </div>
          </div>
