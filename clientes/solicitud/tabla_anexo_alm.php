...
<td> 
                                  <input class="form-control inputsf" id="<? echo "p6".$cont ?>" name="p6" placeholder=""type="number" step="any" value="<? echo $row_anexo_e['p6']; ?>"  />
                              </td>
<td> 
...
<td> 
                                   <input class="form-control inputsf" id="<? echo "p11".$cont ?>" name="p11" placeholder=""type="number" step="any" value="<? echo $row_anexo_e['p11']; ?>"  />
                              </td>
<td> 
