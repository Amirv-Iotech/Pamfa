<fieldset>
				...
				<div class="col-lg-12 col-sm-12 campos2">
					<div class="form-group col-lg-4 col-sm-4 campos2" style="border: solid 1px #AAAAAA; min-height: 136px">
						...
						<div class="col-lg-12 div4">
							<input placeholder="" class="form-control inputsf" onchange="this.form.submit()" name="preg1_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg1_op2'];?>" />
						</div>
					</div>
					<div class=" form-group col-lg-4 col-sm-4 campos2" style="border: solid 1px #AAAAAA; min-height: 136px">
						<label  for="preg2_op2" class="form-label col-lg-12">Número de unidades de producción a certifcar:</label>
						<div class="col-lg-12 div4">
							<input placeholder=""  class="form-control inputsf" onchange="this.form.submit()" name="preg2_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg2_op2'];?>"  />
						</div>
					</div>
					<div class="form-group col-lg-4 col-sm-4 campos2" style="border: solid 1px #AAAAAA; min-height: 136px">
						<label for="preg3_op2" class="form-label col-lg-12">Número de unidades de maniupalación de productos a certificar:</label>
						<div class="col-lg-12 div4">
							<input placeholder="" class="form-control inputsf" onchange="this.form.submit()" name="preg3_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg3_op2'];?>"  />
						</div>
					</div>
				</div>
    ...
    <div class="col-lg-6 col-sm-6 campos2" style="min-height:">
        ...
        <div class="div4">
				<input placeholder="" class="form-control inputsf" onchange="this.form.submit()" name="preg1_tipo2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg1_tipo2'];?>" />
			  </div>
      </div>
			<div class="col-lg-6 col-sm-6 campos2" style="border: solid 1px #AAAAAA; min-height:154px;">
				<div>
				...
				<div class="div4">
          <input placeholder=" "  class="form-control inputsf" onchange="this.form.submit()" name="preg2_tipo2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg2_tipo2'];?>"  />
			   </div>
      </div>
    </div>
            ...
            <div class="form-group col-lg-6 col-xs-6 campos2" style="border: solid 1px #AAAAAA; min-height: 102px;">
              ...
              <div class="div4">
                  <input placeholder=""  class="form-control inputsf" onchange="this.form.submit()" name="preg4_tipo2" type="text"       title="Cantidad " value="<? echo $row_solicitud_esq['preg4_tipo2'];?>" />    
              </div>
            </div>
			</div>
    ...
    <div class="col-lg-12 col-xs-12 campos2">
      ...
      <div class="col-lg-1 col-xs-1 campos2" style="border: solid 1px #AAAAAA; height: 26px;">
       <input onchange="this.form.submit()"  <? if ($row_solicitud_esq['preg6']=="No"){?> checked="checked"<? }?> type="checkbox" value="No" name="preg6">
      </div>
    </div>
    <div class="col-lg-12 col-xs-12 campos2">
      <div class="col-lg-10 col-xs-10 campos2" style="border: solid 1px #AAAAAA; min-height: 26px;">
      ...
      <div class="col-lg-1 col-xs-1 campos2" style="border: solid 1px #AAAAAA; height:26px;">
         <input onchange="this.form.submit()"  <? if ($row_solicitud_esq['preg7']=="No"){?> checked="checked"<? }?> type="checkbox" value="No" name="preg7">
      </div>
    </div>
    <div class="col-lg-12 col-xs-12 campos2">
      <div class="col-lg-10 col-xs-10 campos2" style="border: solid 1px #AAAAAA; min-height:26px;">
      ...
      <div class="col-lg-1 col-xs-1 campos2" style="border: solid 1px #AAAAAA; height: 26px;">
         <input onchange="this.form.submit()"  <? if ($row_solicitud_esq['preg8']=="Si"){?> checked="checked"<? }?> type="checkbox" value="Si" name="preg8">
      </div> 
      <div class="col-lg-1 col-xs-1 campos2" style="border: solid 1px #AAAAAA; height: 26px;">
         <input onchange="this.form.submit()"  <? if ($row_solicitud_esq['preg8']=="No"){?> checked="checked"<? }?> type="checkbox" value="No" name="preg8">
      </div>
    </div>
  ...
  <label><input onchange="this.form.submit()"  type="checkbox" <? if ($row_solicitud_esq['esq_tipo1_op1']==$row_esquema['idesquema']){?> checked="checked"<? }?>  value="<? echo $row_esquema['idesquema'];?>" name="esq_tipo1_op1"><? echo $row_esquema['esquema'];?></label>
    ...
    <? }?></div><?
     ...
     <div class="form-group col-lg-2 col-md-2">
    	...
    	<div class="col-lg-4">
    <input placeholder="" class="form-control" onchange="this.form.submit()" name="preg1_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg1_op2'];?>" />
     </div></div>
      <div class=" form-group col-lg-2 col-md-2">
    	<label  for="preg2_op2" class="form-label col-lg-8">Número de unidades de producción a certifcar:</label>
    	<div class="col-lg-4">
    <input placeholder=""  class="form-control" onchange="this.form.submit()" name="preg2_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg2_op2'];?>"  />
     </div></div>
      <div class="form-group col-lg-2 col-md-2">
    	<label for="preg3_op2" class="form-label col-lg-8">Número de unidades de maniupalación de productos a certificar:</label>
    	<div class="col-lg-4">
    <input placeholder="" class="form-control" onchange="this.form.submit()" name="preg3_op2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg3_op2'];?>"  />
     </div></div>
    ...
    <input placeholder=" " class="form-control" onchange="this.form.submit()" name="preg1_tipo2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg1_tipo2'];?>" />
     </th>
     <th>
     </th>
     <th>
