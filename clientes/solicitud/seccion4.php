	...
	<div class="row" id="seccion4"  style="background-color: #ecfbe7; border: solid 1px #AAAAAA; border-bottom-width:2px;">
		...
		<div class=" form-group col-lg-12 col-sm-12 campos2" style="min-height:90px;">
			<div class="col-lg-6 col-sm-6 campos" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				<label for="rfc" class="form-label">Registro federal de contribuyentes (De preferencia anexar copia):</label>
				 <div class="div4">
					<input  placeholder="" class="form-control inputsf" id="rfc" style="padding-bottom:2px;" name="rfc" type="text"title="RFC " value="<? echo $row_operador['rfc'];?>" class="form-control" />
				</div>
			</div>
			<div class="col-lg-6 col-sm-6 campos2" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input placeholder=" " class="form-control inputsf" id="dir_rfc" name="dir_rfc" type="text" 			title="Dirección " value="<? echo $row_operador['dir_rfc'];?>" class="form-control" />
				</div>
			</div>
		</div>
		...
		<div class="form-group col-lg-12 col-sm-12 campos2" style="min-height:90px;">
			<div class="col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input placeholder=" "  class="form-control inputsf" id="nombre_factura"  name="nombre_factura" type="text" 			title="Nombre " value="<? echo $row_operador['nombre_factura'];?>" class="form-control" />
				</div>
			</div>
			...
			<div class=" col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input placeholder=""  class="form-control inputsf" id="email_factura"  name="email_factura" type="text" 			title="Email " value="<? echo $row_operador['email_factura'];?>" class="form-control" />			
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input placeholder=""  class="form-control inputsf" id="tel_factura"  name="tel_factura" type="text" 			title="Teléfono " value="<? echo $row_operador['tel_factura'];?>" class="form-control" />
				</div>
			</div>
		</div>		
		...
		<div class="form-group col-lg-12 col-sm-12 campos2" style="min-height:90px;">
			<div class="col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input placeholder=" " class="form-control inputsf" id="forma_pago"  name="forma_pago" type="text" 			title="forma de pago " value="<? echo $row_operador['forma_pago'];?>" class="form-control" />
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
			    ...
			    <div class="div4">
					<input placeholder=" " class="form-control inputsf" id="banco"  name="banco" type="text" 			title="Banco " value="<? echo $row_operador['banco'];?>" class="form-control" />
				</div>
			</div>
