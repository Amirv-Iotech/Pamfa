	...
	<div class="row" id="seccion4"   <? if($s4==1){?> style="background-color:#CF3" <? } else{?>style="background-color: #ecfbe7; <? }?>border: solid 1px #AAAAAA; border-bottom-width:2px;">
		...
		<div class="form-group col-lg-12 col-sm-12 campos2" style="min-height:90px;">
			...
			<div class="col-lg-4 col-sm-4" style=" padding: 0px 0px; border:solid 1px #AAAAAA; min-height:90px;">
				...
				<div class="div4">
					<input disabled="disabled" class="form-control inputsf" id="digitos_tarjeta" name="digitos_tarjeta" type="text" 			title="4 digitos  de tarjeta " value="<? echo $row_operador['digitos_tarjeta'];?>" class="form-control" />
				</div>
			</div>
		</div>
