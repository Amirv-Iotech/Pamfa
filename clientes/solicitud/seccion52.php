			...
			<div class="col-lg-6 col-sm-6 campos2" style="min-height: 158px;">
				...
				<? $query_esquema = sprintf("SELECT * FROM esquemas where tipo=1 order by tipo,opcion asc");
					...
					{?>
						...
						{?>
						<label><input   type="radio" <? if ($row_solicitud_esq['esq_tipo1_op1']==$row_esquema['idesquema']){?> checked="checked"<? }?>  value="<? echo $row_esquema['idesquema'];?>" id="esq_tipo1_op1" name="esq_tipo1_op1"/><? echo $row_esquema['esquema'];?></label>
						<? }?></div><?
					}
				?>
...
<<<<<<< HEAD:clientes/solicitud/seccion52.php
...
>>>>>>> anthony:clientes/solicitud/seccion5.php
          ...
          <input placeholder=" "  class="form-control inputsf"  id="preg2_tipo2" name="preg2_tipo2" type="text" 			title="Número " value="<? echo $row_solicitud_esq['preg2_tipo2'];?>"  />
			...
			<div class="col-lg-6 col-sm-6 col-xs-12 campos2" style="min-height: ;"><!--unid2-->
              ...
              <div class="col-lg-6 col-xs-6 campos2" style="border: solid 1px #AAAAAA;">
  							<label><input   type="checkbox"  <? if ($row_solicitud_esq['esq_tipo2_op1']==$row_esquema['idesquema']){?> checked="checked"<? }?> value="<? echo $row_esquema['idesquema'];?>" id="esq_tipo2_op1" name="esq_tipo2_op1"/><? echo $row_esquema['esquema'];?></label>
                </div>
  						<?}
