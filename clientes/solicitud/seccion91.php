	...
	<table border="1" cellpadding="5" cellspacing="0">
      ...
      <th>N°</th>
		...
		while ($row_a = mysql_fetch_assoc($a)){
			...
			<td width="10" >
			<input class="form-control" type="text" name="producto" value="<?php echo $row_a['producto']; ?>" />
			</td>
			<td>
			<input class="form-control" type="text" name="num_productores" value="<?php echo $row_a['num_productores']; ?>" />
			</td>
			<td>
			<input class="form-control" type="text" name="num_fincas" value="<?php echo $row_a['num_fincas']; ?>" />
			</td>
			<td>
			<input class="form-control" type="text" name="ubicacion_unidad" value="<?php echo $row_a['ubicacion_unidad']; ?>" />
			</td>
			<td>
			<input class="form-control" type="text" name="coordenadas" value="<?php echo $row_a['coordenadas']; ?>" />
			</td>
			<td>
			<input class="form-control" type="number" step="any" name="superficie" value="<?php echo $row_a['superficie']; ?>" />
			<?php $cont=$cont+$row_a['superficie'];?>
			</td>
			<td>
			<input class="form-control" type="text" name="periodo_cosecha" value="<?php echo $row_a['periodo_cosecha']; ?>" />
			</td>
			<td>      
				<select class="form-control" name="libre_cubierto" >
					<option  value="-">Seleciona</option>
					<option <?php if($row_a['libre_cubierto']==1){?> selected="selected" <?php }?> value="1">Si</option>
					<option <?php if($row_a['libre_cubierto']==2){?> selected="selected" <?php }?>value="2">No</option>
				</select>
			</td>
			<td>				  
				<select class="form-control" name="cosecha_recoleccion" >
					<option  value="-">Seleciona</option>
					<option <?php if($row_a['cosecha_recoleccion']==1){?> selected="selected" <?php }?> value="1">Si</option>
					<option <?php if($row_a['cosecha_recoleccion']==2){?> selected="selected" <?php }?>value="2">No</option>
				</select>
			</td>
			<td>    
				<select class="form-control" name="empaque" >
				  <option  value="-">Seleciona</option>
				  <option <?php if($row_a['empaque']==1){?> selected="selected" <?php }?> value="1">Si</option>
				  <option <?php if($row_a['empaque']==2){?> selected="selected" <?php }?>value="2">No</option>
				</select>
			</td>
			 <td>
				<input class="form-control" type="text" name="num_trabajadores" value="<?php echo $row_a['num_trabajadores']; ?>" />
			 </td>	 
			<td width="1" align="center">
				<form id="form3" name="form3" method="post" action="">
					<input type="hidden" name="eliminar" value="1" />
					<input type="hidden" name="idsolicitud" value="<?php echo $row_solicitud['idsolicitud']; ?>" />
					<input type="hidden" name="idcultivos" value="<?php echo $row_cultivos['idcultivos']; ?>" />
					<input type="hidden" name="seccion" value="9" />
