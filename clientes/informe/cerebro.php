...
if($total_pre<1)
{
	$insertSQL = sprintf("INSERT INTO informe_nc(notas,anexo,tratada,idpregunta,idinforme) VALUES (%s,%s,%s,%s, %s)",
	 ...
	 $insertSQL = sprintf("Update informe_nc set notas=%s,anexo=%s,tratada=%s where idinforme=%s and idpregunta=%s",
...
$insertSQL = sprintf("Update informe set aspectos=%s,max_nc_men=%s,mejora=%s where idinforme=%s",
