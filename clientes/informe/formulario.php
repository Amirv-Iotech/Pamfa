...
: </label>
                   ...
                   <div class="col-lg-12 col-xs-12 "> &nbsp;</div>
                    ...
                    <input disabled="disabled"  class="plan_input" id="max_nc_men" name="max_nc_men" type="text" value="<? echo $row_inf['max_nc_men'];?>" onchange="<?php echo 'ginf('.$row_inf['idinforme'].')'?>" />
                    </div>
                    ...
                    <div class="col-lg-9 col-xs-9">
                    <textarea  disabled="disabled" class="plan_input" id="aspectos" name="aspectos" onchange="<?php echo 'ginf('.$row_inf['idinforme'].')'?>"><? echo $row_inf['aspectos'];?></textarea>
                    </div>
                    ...
                    <div class="col-lg-9 col-xs-9">
                    <textarea disabled="disabled" class="plan_input" id="mejora" name="mejora" onchange="<?php echo 'ginf('.$row_inf['idinforme'].')'?>"><? echo $row_inf['mejora'];?> </textarea>
                    </div>
