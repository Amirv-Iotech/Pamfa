...
?><br />
  <div class="row" id="seccion5" style="background-color: #ecfbe7; border:solid 2px #dbf573e6">
   ...
   <iframe width="1" height="1"  name="destino"  frameborder="0"></iframe>
       ...
       <tr><? if($_POST['idformato']==1){?> <td>N°</td><td colspan="3">Punto de control</td>  <td colspan="1">Criterio de cumplimiento</td> <td colspan="1">Nivel</td> <td colspan="1">Respuesta</td></tr><? }?>
...
<h4><strong><? if($row_pregunta['ban']==NULL){ echo utf8_decode( $row_pregunta['texto']);} else {  echo $row_pregunta['texto'];} ?></strong></h4>
</td>	 
</tr>
