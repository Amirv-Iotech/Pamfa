...
<td> 
                                   <textarea  class="form-control inputsf" id="<? echo "pp4".$cont ?>" name="p4" > <? echo $row_res['nc']; ?> </textarea>                             </td>
<td> 
                                   <textarea class="form-control inputsf" id="<? echo "pp5".$cont ?>" name="p5" > <? echo $row_res['evidencia']; ?> </textarea> 
                                  </td>
...
<script type="text/javascript"> 
	...
	var idinforme = $("#idinforme").val();
	 ...
	 $.ajax({
		 url:"cerebro.php",
		 method:"POST",
		 data:{seccion:seccion,idinforme:idinforme,idpregunta:idpregunta,p4:p4,p5:p5},
		 success: function() {
