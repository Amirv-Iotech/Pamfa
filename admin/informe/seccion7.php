...
<div class="col-md-12">
  <form method="post" action="#seccion7">
    ...
    <div class="col-md-5">
      <label class="col-md-12 col-lg-12">Observación</label>
      <div class="col-md-12 col-lg-12">
         <input placeholder="escribe aquí"  class="plan_input"  name="observacion_ifa"        title="observacion " type="text" value="<? echo $row_inf['observacion_ifa']; ?>"  />
      </div>
    </div>
    <div class="col-md-5">
      <label class="col-md-12">Dictamen</label>
      <div class="col-md-12">
        <select name="dictamen_ifa" class="plan_input" >
...
<div class="col-lg-12">
  <form method="post" action="#seccion7">
      ...
      <div class="col-lg-5">
          <label class="col-lg-12">Observación</label>
          <div class="col-lg-12">
              <input placeholder="escribe aquí"  class="plan_input"  name="observacion_coc"        title="observacion " type="text" value="<? echo $row_inf['observacion_coc']; ?>"  />
          </div>
      </div>
      <div class="col-lg-5">
        <label class="col-lg-12">Dictamen</label>
        <div clas="col-lg-12">
            <select name="dictamen_coc" class="plan_input" >
            <option value="">Selecciona una opción...</option>
    ...
    <div class="col-lg-12">
      ...
      <form method="post" action="#seccion7">
        ...
        <label>Observacion</label>
          <div class="col-lg-12">
            <input placeholder="escribe aquí"  class="plan_input"  name="observacion_mexcalsup"        title="observacion " type="text" value="<? echo $row_inf['observacion_mexcalsup']; ?>"  />
          </div>
        </div>
        <div class="col-lg-5">
            <label>Dictamen</label>
            <div class="col-lg-12">
              <select name="dictamen_mexcalsup" class="plan_input" >
                <option value="">Selecciona una opción...</option>
