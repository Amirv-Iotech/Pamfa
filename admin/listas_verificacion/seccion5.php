...
<tr class="success">
<td  align="rigth"><? if($row_pregunta['numero']>=10){echo $row_pregunta['prefijo'].$row_pregunta['numero'];}else{ echo $row_pregunta['prefijo'].substr($row_pregunta['numero'],1);}?></td>
<td colspan="6" align="rigth">
<h4><strong><? if($row_pregunta['ban']==NULL){ echo utf8_encode( $row_pregunta['texto']);if ($row_resp['respuesta']!=NULL) {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='material-icons'>done_all</i>";} } else {  echo $row_pregunta['texto'];if ($row_resp['respuesta']!=NULL) {echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='material-icons'>done_all</i>";} } ?></strong></h4>
</td>	 
</tr>
