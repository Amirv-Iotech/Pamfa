...
<? if($mango>0){?>                                                <td>
                                                <form action="listas_verif_menu.php" method="post">
												 ...
												 else if($f6<$array[5]){?> <button data-toggle="tooltip" title="<? echo $f6." No respondidas";?>" type="submit" name="Ver"  value="1"class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i></button><? }else {?>                                                 <button data-toggle="tooltip" title="Ver" type="submit" name="Ver"  value="1"class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i></button><? }?>
                                                 <input type="hidden" name="idsolicitud" value="<? echo $row_solicitud['idsolicitud']; ?>" />
                                                   <input type="hidden" name="idplan_auditoria" value="<? echo $row_plan_auditoria['idplan_auditoria']; ?>" />
</form></td><? } else{?><td>NA</td> <? }?>
