...
if(move_uploaded_file($fileTmpLoc, "docs/$fileName")){
	...
	$query_origen = "SELECT * FROM solicitud_origen where idsolicitud='".$_POST['idsolicitud']."'";
...
$insertSQL6 = "update solicitud_origen set anexo='".$fileName."' WHERE  idsolicitud='".$_POST['idsolicitud']."'";
	...
	$insertSQL6 = "insert into solicitud_origen (idsolicitud,anexo) VALUES ('".$_POST['idsolicitud']."','".$fileName."')";
}
