...
<td> 
                                  <input class="form-control inputsf" id="<? echo "p8".$cont ?>" name="p8" placeholder=""type="text" value="<? echo $row_anexo_p['p8']; ?>"  />
                              </td>
<td> 
...
<td> 
                                   <input class="form-control inputsf" id="<? echo "p13".$cont ?>" name="p13" placeholder=""type="text" value="<? echo $row_anexo_p['p13']; ?>"  />
                              </td>
<td> 
